...
public class Main {
    ...
    private static MobilPhone mobilPhone = new MobilPhone("+372 2123123");
    ...
    private static void addNewContact() {
        ...
        //Creating Contact class objec
        Contact newContact = new Contact(name, phone);
        if (mobilPhone.addNewContact(newContact)) {
            System.out.println("New contact added: name = " + name + " , phone = " + phone);
        } else {
            System.out.println("Cannot add contact with name  " + name + "because it already exists in contact list");
        }
    }
    ...
    private static void updateContact() {
        ...
        String name = scanner.nextLine();
        Contact existingContact = mobilPhone.queryContact(name);
        ...
        if (mobilPhone.updateContact(existingContact, newContact)) {
